<<<<<<< HEAD:edu/gatech/oad/antlab/pkg1/AntLabMain.java
 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Elena May");
		  toPrint += p1.toString("emay7");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Blake Jones");
		  toPrint += p2.toString("bjones325");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Elijah Trexler");
		  toPrint += p3.toString("etrexler8");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ruchi Banerjee");
                  toPrint += p4.toString("rbanerjee34");
...
>>>>>>> bb8b269055b515f7ab170b014e4182298d1a03de:src/main/java/edu/gatech/oad/antlab/pkg1/AntLabMain.java
